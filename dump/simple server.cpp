...
#define RELAY_PIN 4   // Set the GPIO pin where you connected your test LED or comment this line out if your dev board has a built-in LED

// Set these to your desired credentials.
// const char *ssid = "Ciheulang 3";
// const char *password = "CBnotiga";

const char *ssid = "Yang Mana Hayo";
const char *password = "wkwkwklimakali";
