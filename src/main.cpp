/*********
  Royyan Dzakiy - Smart Terminal Project
...
const char* ssid     = "Inventor's Smart Terminal";
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>Inventor's Smart Terminal</h1>");
            
            // Display current state, and ON/OFF buttons for GPIO 4  
            client.println("<p>Terminal - State " + output4State + "</p>");
